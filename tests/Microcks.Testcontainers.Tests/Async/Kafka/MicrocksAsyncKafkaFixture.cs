...
public class MicrocksAsyncKafkaFixture : IDisposable
{
    ...
    public MicrocksAsyncKafkaFixture()
    {
        var network = new NetworkBuilder().Build();

        this.KafkaContainer = CreateKafkaContainer(network);
        ...
        this.KafkaContainer.StartAsync().GetAwaiter().GetResult();
        this.MicrocksContainerEnsemble.StartAsync().GetAwaiter().GetResult();
    }
    ...
    public void Dispose()
    {
        this.KafkaContainer.DisposeAsync().GetAwaiter().GetResult();
    }
}
